...
type PortfolioSection = {
  ...
  title: string;
  description: string;
  svgs?: ReactElement<SVGProps<SVGSVGElement>>[];
  tags?: string[];
  projects?: {
    title: string;
    description: string;
...
const sections: PortfolioSection[] = [
  ...
  },
  {
    ...
    svgs: [
      ...
      <svg key="javascript" viewBox="0 0 128 128">
      ...
      <svg key="java" viewBox="0 0 128 128">
        <path
          fill="#0074BD"
      ...
      <svg key="nodejs" viewBox="0 0 128 128">
        <path
      ...
      <svg key="html" viewBox="0 0 128 128">
        <path
          fill="#E44D26"
      ...
      <svg key="css" viewBox="0 0 128 128">
        <path
          fill="#1572B6"
      ...
      <svg key="tailwind" viewBox="0 0 128 128">
        <path
          fill="#38bdf8"
      ...
      <svg key="aws" viewBox="0 0 128 128">
        <path
          fill="#252f3e"
      ...
      <svg key="react" viewBox="0 0 128 128">
        <g fill="#61DAFB">
      ...
      <svg key="cloudflare" viewBox="0 0 128 128">
        <path
          fill="#FFF"
      ...
      <svg key="docker" viewBox="0 0 128 128">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          fill="#3A4D54"
      ...
      <svg key="python" viewBox="0 0 128 128">
        <linearGradient
      ...
      <svg key="swagger" viewBox="0 0 128 128">
        <path
          fill="#85ea2d"
                  ...
                  {section.svgs?.map((svg, index) => (
                    ...
                    >
                      {cloneElement(svg, {
                        "aria-hidden": true,
                        className: cn(
                          "block h-full w-full shrink-0 overflow-visible",
                          svg.props.className,
                        ),
                        focusable: false,
                        preserveAspectRatio:
                          svg.props.preserveAspectRatio ?? "xMidYMid meet",
                        xmlns: svg.props.xmlns ?? "http://www.w3.org/2000/svg",
                      })}
                    </div>
                  ))}
